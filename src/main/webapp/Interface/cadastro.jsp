...
<html>
    ...
    <body>
        <div class="page-wrap">
            ...
            <section id="register"><!--picking the same css design config from contact in the main page-->
                <!--<script type="text/javascript" src="assests/js/jquery-3.1.0.min.js"></script>
